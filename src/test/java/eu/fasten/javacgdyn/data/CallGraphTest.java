...
class CallGraphTest {
    ...
    public static void setUp() {
        ...
        var source = new Method("product", "1.0", "package.name", "Class", "method1",
                new String[]{"int", "boolean"}, "V", 1, 5);
        var target = new Method("product", "1.0", "different.name", "Target", "callee",
                new String[]{}, "int", 6, 7);
        var target2 = new Method("product", "1.0", "different.name", "Target", "callee2",
